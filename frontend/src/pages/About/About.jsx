  ...
  return (
    <div id="about">
      ...
      <div id="mission&vission">
        <div>
          <div></div>
          <h3>Delivering Quality and Customer Satisfaction Globally</h3>
          <p>At ARASCO EXPORT INDIA, our mission is to provide top-quality food products that meet the diverse needs of our customers worldwide. We are committed to ensuring customer satisfaction through our dedication to sourcing the finest spices, pulses, rice, dry fruits, oils, and sugars while maintaining rigorous quality standards.</p>
        </div>
        <div>
          <div></div>
          <h3>Becoming a Global Leader in Food Exports</h3>
          <p>Our vision is to be a globally recognized leader in the food export industry, known for reliability, excellence, and innovation. We aim to expand our reach, enhance customer relationships, and continually provide superior products that promote health and well-being across the world.</p>
        </div>
      </div>
